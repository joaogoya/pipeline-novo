...
?>
 <!--====== HEADER START ======-->
            ...
            <div class="mainmenu-area">
                <div class="d-flex align-items-center justify-content-between">
                    <nav class="main-menu">
                        <div class="logo">
                            <a href="index.html">
                                <img src="assets/img/logo-white.png" alt="Onitit" class="normal-logo">
                                <img src="assets/img/logo.png" alt="Onitit" class="sticky-logo">
                            </a>
                        </div>
                            ...
                            <ul>
                                <li class="active">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li><a href="index-3.html">Home There</a></li>
                                    </ul>
                                </li>
                                <li>
    ...
    <section class="banner-section banner-style-three banner-slider-two"
        style="background-image: url(assets/img/banner/02.jpg);">
...
<section class="about-section about-style-three pt-120 pb-120">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 col-md-10 order-last order-lg-first"> <div class="about-text pr-30">
                    <div class="section-title left-border mb-40">
                        <span class="title-tag">Seu Problema?</span>
                        <h2>Você enfrenta estes desafios com [Serviço]?</h2> </div>
                    <p>
                        Descreva aqui as dores e dificuldades que seu cliente ideal sente. Use linguagem que ele entenda e que gere identificação. Exemplos:
                        "Perdendo clientes por não ter visibilidade online?",
                        "Seu negócio local não aparece no Google Maps?",
                        "Dificuldade em atrair tráfego qualificado para seus serviços?".
                    </p>
                    </div>
            </div>
            <div class="col-lg-6 col-md-10 order-first order-lg-last"> <div class="about-img">
                    <img src="assets/img/placeholder-problema.jpg" alt="Ilustração do problema do cliente">
                </div>
            </div>
        </div>
    </div>
</section>
<div class="section-divider"></div> <section class="about-section about-style-three pt-120 pb-120 bg-light"> <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 col-md-10"> <div class="about-img">
                    <img src="assets/img/placeholder-solucao.jpg" alt="Ilustração da solução do serviço">
                </div>
            </div>
            <div class="col-lg-6 col-md-10">
                <div class="about-text pr-30">
                    <div class="section-title left-border mb-40">
                        <span class="title-tag">Nossa Solução</span>
                        <h2>Como [Serviço] resolve seu problema</h2> </div>
                    <p>
                        Explique aqui como seu serviço resolve o problema apresentado. Seja claro e conciso sobre os benefícios diretos. Exemplo para Google Meu Negócio:
                        "Com um perfil otimizado no Google Meu Negócio, sua empresa aparece para quem está buscando serviços como o seu na sua região, aumentando as chances de contato e venda."
                    </p>
                    <ul>
                        <li>Benefício 1</li>
                        <li>Benefício 2</li>
...
<section class="about-section about-style-three pt-120 pb-120">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 col-md-10 order-last order-lg-first">
                <div class="about-text pr-30">
                    <div class="section-title left-border mb-40">
                        <span class="title-tag">Por que nós?</span>
                        <h2>O diferencial da Pipeline Digital</h2> </div>
                    <p>
                        Aqui você destaca o que torna sua agência única. Foco na expertise, no atendimento, nos resultados comprovados.
                        "Somos especialistas em otimizar perfis de negócios locais para máxima visibilidade.",
                        "Nossa equipe acompanha as tendências do Google para garantir que você esteja sempre à frente.",
                        "Entregamos relatórios claros e resultados mensuráveis."
                    </p>
                     </div>
            </div>
            <div class="col-lg-6 col-md-10 order-first order-lg-last">
                <div class="about-img">
                    <img src="assets/img/placeholder-diferencial.jpg" alt="Diferenciais da Pipeline Digital">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-lg-6 col-md-4 col-sm-5 d-none d-sm-block">
                    <div class="service-page-link- text-right">
                        <a href="services.html" class="main-btn btn-filled">learn more</a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-6">
                    <div class="portfolio-box">
                        ...
                        <div class="portfolio-desc">
                            ...
                            <h2><a href="#">Miranda grocery app design</a></h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-5 col-sm-5 d-none d-sm-block">
                    <div class="contact-page-link text-right">
                        <a href="#" class="main-btn btn-filled">get direction</a>
                    </div>
                </div>
            </div>
