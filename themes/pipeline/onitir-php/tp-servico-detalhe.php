                ...
                <div class="col-lg-8">
                    <div class="service-details">
                        <div class="thmb mb-50">
                            <img src="assets/img/details/01.jpg" alt="Image">
                        </div>
                        ...
                        <div class="feature-list-wrap mb-50">
                            ...
                            <div class="feature-list">
                                <div class="row align-items-center">
                                    <div class="col-sm-5">
                                        <div class="list-img">
                                            <img src="assets/img/details/02.jpg" alt="Image">
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
                                        <div class="list-text">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="widget service-cat-widget mb-40">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Data Structuring</a></li>
                                <li><a href="#">Experience Design</a></li>
                                <li><a href="#">Content Engineering</a></li>
                            </ul>
                        </div>
                        <!-- Brouchers widget -->
