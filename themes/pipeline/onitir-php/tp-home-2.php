                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-sm-7">
                        <ul class="contact-list">
                            ...
                            <li><a href="#">+988 987 876 87 67 6</a></li>
                        </ul>
                    </div>
        ...
        <div class="mainmenu-area">
            <div class="container-fluid custom-container-two">
                <div class="d-flex align-items-center justify-content-between">
                    <nav class="main-menu">
                        <div class="logo">
                            <a href="index.html"><img src="assets/img/logo.png" alt="Onitit"></a>
                        </div>
                    ...
                    <div class="col-lg-5 col-md-10">
                        <div class="about-text position-relative">
                            ...
                            <p>Entrepreneurs, artist, athletes and other individuals who have excelled in their field
                                ...
                                in
                                their field share.</p>
                            <a href="#" class="main-btn btn-filled mt-40">Get Started Now</a>
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-lg-6 col-md-10">
                    <div class="feature-text pl-50">
                        ...
                        <a href="#" class="main-btn btn-filled mt-40">Our Services</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="services-slider row">
                    <div class="col-lg-4">
                        <div class="single-slider" style="background-image: url(assets/img/services/img-01.jpg);">
                            <h6>
                                <a href="service-details.html">Custom Software Development</a>
                            </h6>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="single-slider" style="background-image: url(assets/img/services/img-02.jpg);">
                            <h6>
                                <a href="service-details.html">Outsoursing Development</a>
                            </h6>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="single-slider" style="background-image: url(assets/img/services/img-03.jpg);">
                            <h6>
                                <a href="service-details.html">Software Product Development</a>
                            </h6>
                        </div>
                    </div>
                    <div class="col-lg-4">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-4 col-sm-5 col-6">
                    <div class="blog-btn text-right">
                        <a href="news.html" class="main-btn btn-filled">learn more</a>
                    </div>
                </div>
            </div>
            <!-- post Loop -->
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="post-grid-box mb-30">
                                    ...
                                    <div class="post-desc">
                                        <h4><a href="single-news.html">All these data frustrate the user and leads.</a>
                                        </h4>
                    ...
                    <div class="col-lg-5 col-md-10 col-sm-10 order-1 order-lg-2">
                        <div class="post-grid-box mb-30">
                            ...
                            <div class="post-desc">
                                <h4><a href="single-news.html">Consider we have two screens of the ui app, the first
